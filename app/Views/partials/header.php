        ...
        <div class="row justify-content-between align-items-center">
          ...
          <div class="app-search-box col">
            <form class="app-search-form">
              ...
              <button type="submit" class="btn search-btn btn-primary" value="Buscar"><i
            ...
            <div class="app-utility-item app-user-dropdown dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                <li><a class="dropdown-item"
                    href="account.html"><?php echo session()->get('usuario')['nombre'] . ' ' . session()->get('usuario')['apellido']; ?></a>
                </li>
  ...
  <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden">
    ...
    <div class="sidepanel-inner d-flex flex-column">
      ...
      <div class="app-branding">
        <a class="app-logo" href="<?= base_url(); ?>"><img class="logo-icon me-2"
      ...
      <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
          ...
          <li class="nav-item has-submenu">
            ...
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" data-bs-target="#submenu-venta"
          ...
          <li class="nav-item has-submenu">
            ...
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" data-bs-target="#submenu-productos"
              ...
              <ul class="submenu-list list-unstyled">
                <li class="submenu-item">
                  <a class="submenu-link" href="notifications.html">
                    <span class="nav-link-text">
                      <!-- Icono a la   izquierda -->
                      <svg width="1.2em" height="1.2em" class="bi bi-files" fill="currentColor"
          ...
          <li class="nav-item has-submenu">
            ...
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" data-bs-target="#submenu-clientes"
          ...
          <li class="nav-item has-submenu">
            ...
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" data-bs-target="#submenu-compras"
          ...
          <li class="nav-item has-submenu">
            ...
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" data-bs-target="#submenu-reportes"
          ...
          <li class="nav-item has-submenu">
            ...
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse" data-bs-target="#submenu-cajas"
          ...
          <li class="nav-item has-submenu">
            <a class="nav-link submenu-toggle" data-bs-toggle="collapse"
              data-bs-target="#submenu-configuracion" aria-expanded="false" aria-controls="submenu-configuracion">
              <span class="nav-icon">
            ...
            <div id="submenu-configuracion" class="collapse submenu submenu-configuracion"
              ...
              <ul class="submenu-list list-unstyled">
                ...
                <li class="submenu-item has-submenu">
                  <a class="submenu-link submenu-toggle" data-bs-toggle="collapse"
